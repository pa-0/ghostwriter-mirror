 ...
 * ============
 *
 * The following widget states are supported for any color.  Simply append the color varaible name
 * with a hyphen and the state listed below to have a new opacity applied.
 *
